...
#**** Document Analysis ***************
# 
# usage example: perl conll-eval.pl -d "\t" < [File generated from crf_test]
#     where -d is separator character. 
#     The crf_test file outputs columns separated by tabs by default, not spaces. 
#     The coneval script has a single space as delimiter by default.
#     To use with your examples use the option -d "\t"
#
#**** Document Analysis ****************
